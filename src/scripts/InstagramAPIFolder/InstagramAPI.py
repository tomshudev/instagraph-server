...
try:
    ...
    from .ImageUtils import getImageSize
try:
    from exceptions import UserNotFoundException, LoginFailedException, MediaNotFoundException, AccountBlockedException, PasswordIncorrectException, LimitReachedException, LoginRequired, SentryBlockException
except:
    from .exceptions import UserNotFoundException, LoginFailedException, MediaNotFoundException, AccountBlockedException, PasswordIncorrectException, LimitReachedException, LoginRequired, SentryBlockException
...
class InstagramAPI:
    ...
    def getSelfUsersFollowing(self, maxid=''):
        return self.getUserFollowings(self.username_id, maxid)
